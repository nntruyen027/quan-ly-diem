...
import { GradeTableBySubject, RatingTableByClass, } from '~/components';
    ...
    <div>
      ...
      <div className='w-full flex gap-3 my-3'>
        ...
        <FormControl fullWidth size='small'>
          ...
          >
            <MenuItem value={0}>{translate('total')}</MenuItem>
      ...
      {subjectId != 0 ? <GradeTableBySubject data={grades}/> : 
